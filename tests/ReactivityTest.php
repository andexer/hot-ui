...
use Components\Reactivity\HtmlTransform;
use Components\Reactivity\Snapshot;
use Components\Ui;
...
final class ReactivityTest extends TestCase
{
    private string $tmp;

    protected function setUp(): void
    {
        $this->tmp = sys_get_temp_dir().'/hot-ui-react-'.uniqid();
        $views = $this->tmp.'/views/components/live';
    ...
    private function signedCounter(): array
    {
        ...
        return Snapshot::encode(['class' => Counter::class, 'state' => $component->state()], 'test-key');
    }
    ...
    public function testHydrateCallsBootedHook(): void
    {
        $component = new Counter();
    ...
    public function testRenderReturnsFragmentAndSignedSnapshot(): void
    {
        ...
        self::assertStringContainsString('Contar (3)', $result['html']);
    ...
    public function testCallRunsPublicMethodAndReRenders(): void
    {
        ...
        self::assertStringContainsString('Contar (1)', $result['html']);
    }
    ...
    public function testCallModelUpdateCastsAndReRenders(): void
    {
        ...
        self::assertStringContainsString('Contar (8)', $result['html']);
    }
    ...
    public function testCallRejectsUnknownMethod(): void
    {
        ...
        $this->expectException(\RuntimeException::class);
        Engine::call($snapshot, ['name' => 'call', 'method' => 'bogus'], 'x', 'test-key', $this->ui());
    }
