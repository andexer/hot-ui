...
>
    <?php if ($name): ?>
        <input type="hidden" :name="<?= $nameJs ?> + '_country'" :value="country">
        <input type="hidden" :name="<?= $nameJs ?> + '_dial'" :value="selected.dial">
    <?php endif; ?>
    ...
    >
        ...
        <i data-lucide="chevron-down" class="size-4 shrink-0 opacity-50 transition-transform" ::class="open && 'rotate-180'" aria-hidden="true"></i>
    </button>
